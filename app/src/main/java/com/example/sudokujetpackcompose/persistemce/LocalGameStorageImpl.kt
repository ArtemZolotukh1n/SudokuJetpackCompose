...
import com.example.sudokujetpackcompose.domain.GameStorageResult
import com.example.sudokujetpackcompose.domain.IGameDataStorage
...
class LocalGameStorageImpl(
    ...
    private val pathToStorageFile: File = File(
